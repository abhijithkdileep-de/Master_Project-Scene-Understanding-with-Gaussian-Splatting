...
from chorus.models.utils.serialization import encode
from chorus.models.utils.misc import (
    offset2batch,
    batch2offset,
    offset2bincount,
    bincount2offset,
...
class Point(Dict):
    ...
    def __init__(self, *args, **kwargs):
        ...
        # we pop "lang_feat" / "dino_feat" here to avoid lang pretraining data duplication
        for feat_name in ["lang_feat", "dino_feat", "pe_feat"]:
