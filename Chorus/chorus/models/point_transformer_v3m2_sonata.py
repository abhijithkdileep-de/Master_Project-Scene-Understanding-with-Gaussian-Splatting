...
from chorus.models.utils.misc import offset2bincount
from chorus.models.utils.structure import Point
from chorus.models.modules import PointModule, PointSequential
...
class GridPooling(PointModule):
    ...
    def forward(self, point: Point):
        ...
        if self.traceable:
            point_dict["pooling_inverse"] = cluster # Inverse mapping for upsampling
            point_dict["pooling_parent"] = point    # Parent point for before pooling
        order = point.order
...
class GridUnpooling(PointModule):
    ...
    def forward(self, point):
        ...
        parent.sparse_conv_feat = parent.sparse_conv_feat.replace_feature(parent.feat) # parameter-free
