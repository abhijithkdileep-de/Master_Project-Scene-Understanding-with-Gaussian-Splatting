# Standalone inference config for LangPretrainerMultiTeacher.
...
grid_sample_keys = feat_keys + (
    "opacity",
    "quat",
    "scale",
)
grid_sample_keys_test = feat_keys + (
    "opacity",
    "quat",
    "scale",
)
...
inference = dict(
    ...
    # *.ply input is unsupported for Chorus point-variant, please convert to npys of ("coord", "color", "normal")
    input_reader=dict(
        outlier_filter=dict(
            enabled=True,
            method="mad",
