...
model = dict(
    ...
    backbone=dict(
        ...
        dec_depths=(1, 1, 1, 1),
        dec_channels=(512, 512, 512, 512), # <- this direction
        dec_num_head=(32, 32, 32, 32),
        ...
        freeze_embedding=False, # note this has effect when freeze_encoder=True
    ),
    projector_in_channels=1232, # enc_mode=True, take the sum of enc stages
