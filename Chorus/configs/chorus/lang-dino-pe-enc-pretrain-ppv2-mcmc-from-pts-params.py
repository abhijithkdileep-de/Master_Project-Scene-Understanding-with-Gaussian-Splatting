...
hooks = [
    ...
    dict(type="CheckpointSaver", save_freq=15, save_best_for=["lang"]),
    dict(
...
data = dict(
    ...
    train=dict(
        ...
        filtered_scene=["281ba69af1", "47b37eb6f9", "7e7cd69a59", "88627b561e", "578511c8a9", "ac48a9b736", "e9ac2fc517"],
        skip_pe=False,
        transform=[
