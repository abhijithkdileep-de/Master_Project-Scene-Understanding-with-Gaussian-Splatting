...
model = dict(
    ...
    teachers=[
        dict(
            name="pe_spatial",
            target_key="pe_spatial",
            mask_key="valid_feat_mask",
            segment_key="segment",
            light_projector=False,
            teacher_2D_model = 'PE-Spatial-L14-448',
            ...
            criteria=[
                dict(type="CosineSimilarity", reduction="mean", loss_weight=0.5),
                dict(type="SmoothL1Loss", reduction="mean", loss_weight=0.5),
            ],
        ...
        dict(
            ...
            segment_key="segment",
            light_projector=False,
            teacher_2D_model = 'google/siglip2-base-patch16-512',
            downsample_ratio_2D = 2,
            projector=dict(
                out_channels=768,
                depth=1,
            ...
            criteria=[
                dict(type="CosineSimilarity", reduction="mean", loss_weight=0.2),
                dict(type="SmoothL1Loss", reduction="mean", loss_weight=0.2),
            ],
            teacher_norm=dict(enabled=False),
        ),
        dict(
