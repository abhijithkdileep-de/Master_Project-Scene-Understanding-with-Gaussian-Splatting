...
model = dict(
    ...
    backbone=dict(
        type="PT-v3m1",
        in_channels=14,  # gaussian: color 3, quaternion 4, scale: 3 opacity 1, test add normal here, as it's the 3dgs version with fixed xyz
        order=("z", "z-trans", "hilbert", "hilbert-trans"),
        stride=(2, 2, 2, 2),
        enc_depths=(2, 2, 2, 6, 2),
        enc_channels=(32, 64, 128, 256, 512),
        enc_num_head=(2, 4, 8, 16, 32),
        enc_patch_size=tuple(x * 2 for x in (1024, 1024, 1024, 1024, 1024)),
        dec_depths=(2, 2, 2, 2),
        dec_channels=(64, 64, 128, 256),
        dec_num_head=(4, 4, 8, 16),
        dec_patch_size=tuple(x * 2 for x in (1024, 1024, 1024, 1024)),
        mlp_ratio=4,
        qkv_bias=True,
        qk_scale=None,
        attn_drop=0.0,
...
hooks = [
    ...
    dict(
        ...
        class_names="/gpfs/work3/0/prjs1291/datasets/gaussian_world/preprocessed/scannetpp_v1_default_fix_xyz_gs/metadata/semantic_benchmark/top100.txt",
        text_embeddings="/gpfs/work3/0/prjs1291/datasets/gaussian_world/preprocessed/scannetpp_v1_default_fix_xyz_gs/metadata/semantic_benchmark/top100_text_embeddings_siglip2.pt",
