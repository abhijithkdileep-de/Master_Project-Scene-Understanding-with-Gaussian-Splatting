...
# scheduler settings  # total epoch, data loop = epoch // eval_epoch
...
data_root = "/home/yli7/scratch-shared/datasets/gaussian_world/preprocessed/scannetpp_v2_mcmc_3dgs"
...
hooks = [
    ...
    dict(type="SemSegEvaluator", enable_voting=True, vote_k=25, ignore_index=-1),
