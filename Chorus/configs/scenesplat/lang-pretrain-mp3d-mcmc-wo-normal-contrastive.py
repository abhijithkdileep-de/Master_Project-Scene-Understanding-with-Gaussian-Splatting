...
scannet_data_root = "/gpfs/work3/0/prjs1291/datasets/gaussian_world/preprocessed/scannet_3dgs_mcmc_preprocessed"
scannetpp_data_root = (
    "/gpfs/work3/0/prjs1291/datasets/gaussian_world/preprocessed/scannetpp_v2_mcmc_3dgs"
)
matterport3d_data_root = "/gpfs/work3/0/prjs1291/datasets/gaussian_world/preprocessed/matterport3d_region_mcmc_3dgs"
holicity_data_root = (
    "/gpfs/work3/0/prjs1291/datasets/gaussian_world/preprocessed/holicity_mcmc_3dgs"
)
...
hooks = [
    ...
    dict(
        ...
        class_names=f"{repo_root}/pointcept/datasets/preprocessing/matterport3d/meta_data/matterport_labels_21.txt",
        text_embeddings=f"{repo_root}/pointcept/datasets/preprocessing/matterport3d/meta_data/matterport21_text_embeddings_siglip2.pt",
...
data = dict(
    ...
    train=dict(
        ...
        split=(
            "test_grid1.0cm_chunk6x6_stride3x3_filtered",
            ...
            test_cfg=dict(
                voxelize=dict(
                    ...
                    keys=(
                        ...
                        "lang_feat",
                        "valid_feat_mask",
                    ),  # keep keys for inference is enough here
                    apply_to_pc=False,
                    return_grid_coord=True,
                ),
                crop=None,
...
test = [
    ...
    # dict(
    # type='ZeroShotSemSegTester',
    # class_names="{repo_root}/pointcept/datasets/preprocessing/holicity/metadata/semseg_labels.txt",
    # text_embeddings="{repo_root}/pointcept/datasets/preprocessing/holicity/metadata/holicity_text_embeddings_siglip2.pt",
    # excluded_classes=[],
    # enable_voting=True,
    # vote_k=25,
    # confidence_threshold=0.1,
