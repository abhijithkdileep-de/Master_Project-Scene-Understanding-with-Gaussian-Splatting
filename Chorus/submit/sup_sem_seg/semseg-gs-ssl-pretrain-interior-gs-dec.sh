...
python -u -m tools.train \
  --config-file configs/interior_gs/semseg-gs-ptv3m2-interior-gs-ssl-dec.py \
  --options \
    save_path=exp_runs/sup_sem_seg/interior-gs-dec-probe-for-ssl-pretrain-ppv2 \
    ...
    weight=exp_runs/ckpt/sonata_gs_input_scannetppv2_100e.pth \
  --num-gpus $gpu_num \
