...
#   resume=True \
#   weight=exp_runs/lang_pretrainer/multi_teacher/concat_dataset/lang-enc-pretrain-multi-teacher-scan-ppv2-matt/model/best_lang.pth \
...
srun python -u -m tools.train \
  ...
  --options \
    save_path=exp_runs/lang_pretrainer/chorus/concat_dataset/lang-dino-enc-pretrain-scan-ppv2-mp3d-mcmc \
