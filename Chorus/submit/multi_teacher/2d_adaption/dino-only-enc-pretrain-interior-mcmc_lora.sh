#!/bin/bash
#SBATCH --job-name=chorus_2d_dino
...
#SBATCH --mem=240G
#SBATCH --time=7-0
#SBATCH --output=sbatch_log/chorus_2d_dino.log
...
SAVE_PATH=${SAVE_PATH:-exp_runs/lang_pretrainer/chorus/2d_adaption/dino-only-enc-pretrain-interior-mcmc_lora}
